...
CASES = [
    ...
    tc("TC-EVSE-SAFE-002", "EVSE", "Permit false forces relay off", "SWRS-EVSE-004", "SWE.5", "Component", "P0", "Decision", "Start in CHARGING with relay ON, then remove charge permit.", "Relay command turns OFF and the FSM enters FAULT.", "tests/host/evse/test_evse_core_host.py"),
